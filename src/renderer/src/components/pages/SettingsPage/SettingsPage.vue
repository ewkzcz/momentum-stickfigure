              ...
              <n-tab-pane name="basic" tab="基础设置">
                ...
                >
                  ...
                  <n-form-item label="图片保存根目录" path="outputRoot">
                    <n-input-group>
                      <n-input
                        v-model:value="stickfigureConfig.outputRoot"
                      ...
                      <n-button
                        type="primary"
                        @click="selectStickfigureOutputFolder"
                      ...
                      <n-button
                        @click="resetStickfigureOutputToDefault"
                  ...
                  <n-form-item label="导出文件名规则" path="fileNamingRule">
                    <n-select
                      v-model:value="stickfigureConfig.fileNamingRule"
                  ...
                  <n-form-item label="同名文件处理" path="duplicateFileHandling">
                    <n-radio-group v-model:value="stickfigureConfig.duplicateFileHandling">
                      <n-space>
                  ...
                  <n-form-item label="PSD文件夹组织" path="createPsdFolder" style="margin-top: 12px;">
                    <n-radio-group v-model:value="stickfigureConfig.createPsdFolder">
                      <n-space>
                        <n-radio :value="true">
                          是（推荐）
                        </n-radio>
                  ...
                  <n-form-item label="动作表情模糊匹配" path="enableFuzzyMatch" style="margin-top: 12px;">
                    <n-radio-group v-model:value="stickfigureConfig.enableFuzzyMatch">
                      <n-space>
                        <n-radio :value="true">
                          是（推荐）
                        </n-radio>
          ...
          <div class="settings-content">
            ...
            >
              ...
              <n-form-item label="主窗口唤醒/最小化" path="toggleMainWindow">
                <n-input-group>
                  <n-input
                    v-model:value="hotkeysConfig.toggleMainWindow"
                    placeholder="点击后按下快捷键组合"
                    readonly
                    :style="{ flex: 1 }"
                    @keydown="handleHotkeyInput($event, 'toggleMainWindow')"
                    @focus="currentEditingHotkey = 'toggleMainWindow'"
                    @blur="currentEditingHotkey = null"
                  />
                  <n-button
                    @click="resetHotkey('toggleMainWindow')"
                    title="重置为默认值（Alt+Z）"
                  >
                    <template #icon>
                      <n-icon>
                  ...
                  <n-button
                    type="error"
                    @click="clearHotkey('toggleMainWindow')"
                    title="清空快捷键"
                  >
                    清空
                  </n-button>
              ...
              <n-form-item label="预览窗口唤醒/最小化" path="togglePreviewWindow">
                <n-input-group>
                  <n-input
                    v-model:value="hotkeysConfig.togglePreviewWindow"
                    placeholder="点击后按下快捷键组合"
                    readonly
                    :style="{ flex: 1 }"
                    @keydown="handleHotkeyInput($event, 'togglePreviewWindow')"
                    @focus="currentEditingHotkey = 'togglePreviewWindow'"
                    @blur="currentEditingHotkey = null"
                  />
                  <n-button
                    @click="resetHotkey('togglePreviewWindow')"
                    title="重置为默认值（Alt+X）"
                  >
                    <template #icon>
                      <n-icon>
                  ...
                  <n-button
                    type="error"
                    @click="clearHotkey('togglePreviewWindow')"
                    title="清空快捷键"
                  >
                    清空
                  </n-button>
              ...
              <n-form-item label="打开搜索面板" path="openSearch">
                <n-input-group>
                  <n-input
                    v-model:value="hotkeysConfig.openSearch"
                    placeholder="点击后按下快捷键组合"
                    readonly
                    :style="{ flex: 1 }"
                    @keydown="handleHotkeyInput($event, 'openSearch')"
                    @focus="currentEditingHotkey = 'openSearch'"
                    @blur="currentEditingHotkey = null"
                  />
                  <n-button
                    @click="resetHotkey('openSearch')"
                    title="重置为默认值（Ctrl+F）"
                  >
                    <template #icon>
                      <n-icon>
              ...
              <n-form-item label="切换悬浮预览（主画布）" path="toggleCanvasHover">
                <n-input-group>
                  <n-input
                    v-model:value="hotkeysConfig.toggleCanvasHover"
                    placeholder="点击后按下快捷键组合"
                    readonly
                    :style="{ flex: 1 }"
                    @keydown="handleHotkeyInput($event, 'toggleCanvasHover')"
                    @focus="currentEditingHotkey = 'toggleCanvasHover'"
                    @blur="currentEditingHotkey = null"
                  />
                  <n-button
                    @click="resetHotkey('toggleCanvasHover')"
                    title="重置为默认值（Alt+C）"
                  >
                    <template #icon>
                      <n-icon>
                  ...
                  <n-button
                    type="error"
                    @click="clearHotkey('toggleCanvasHover')"
                    title="清空快捷键"
                  >
                    清空
                  </n-button>
              ...
              <n-form-item label="切换悬浮预览（部件）" path="togglePartHover">
                <n-input-group>
                  <n-input
                    v-model:value="hotkeysConfig.togglePartHover"
                    placeholder="点击后按下快捷键组合"
                    readonly
                    :style="{ flex: 1 }"
                    @keydown="handleHotkeyInput($event, 'togglePartHover')"
                    @focus="currentEditingHotkey = 'togglePartHover'"
                    @blur="currentEditingHotkey = null"
                  />
                  <n-button
                    @click="resetHotkey('togglePartHover')"
                    title="重置为默认值（Alt+V）"
                  >
                    <template #icon>
                      <n-icon>
                  ...
                  <n-button
                    type="error"
                    @click="clearHotkey('togglePartHover')"
                    title="清空快捷键"
                  >
                    清空
                  </n-button>
          ...
          <div class="settings-content">
            ...
            >
              <n-form-item label="中转站地址" path="baseUrl" required>
                <n-input
                  v-model:value="geminiConfig.baseUrl"
              ...
              <n-form-item label="API 密钥" path="apiKey" required>
                <n-input
                  v-model:value="geminiConfig.apiKey"
                  type="password"
              ...
              <n-form-item label="保存根目录" path="projectRoot">
                <n-input-group>
                  <n-input
                    v-model:value="geminiConfig.projectRoot"
                  ...
                  <n-button
                    @click="resetProjectRootToDefault"
                    title="重置为默认路径"
                  >
                    <template #icon>
                      <n-icon>
              ...
              <n-form-item label="图片保存路径" path="outputDir">
                <n-input
                  v-model:value="geminiConfig.outputDir"
                  placeholder="图片保存路径"
                />
                <template #feedback>
                  <n-text depth="3" style="font-size: 12px;">
              ...
              <n-form-item label="日志路径" path="logDir">
                <n-input
                  v-model:value="geminiConfig.logDir"
                  placeholder="日志文件路径"
                />
                <template #feedback>
                  <n-text depth="3" style="font-size: 12px;">
