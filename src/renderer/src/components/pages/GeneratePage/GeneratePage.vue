...
import { useTaskStore, TaskType, TaskStatus } from '@renderer/stores/taskStore.js'
import { GEMINI_IMAGE_CONFIG_STORAGE_KEY } from '@renderer/config/gemini-image-config.js'
import { buildGeminiDragConfig, resolveGeminiProjectRoot } from '@renderer/utils/geminiOutputConfig.js'
