...
const browserGlobals = Object.fromEntries(['window', 'document', 'location', 'navigator', 'Image', 'HTMLImageElement', 'MouseEvent', 'requestAnimationFrame', 'cancelAnimationFrame', 'performance', 'FileReader', 'Blob', 'localStorage', 'sessionStorage', 'ResizeObserver', 'MutationObserver', 'IntersectionObserver'].map((name) => [name, 'readonly']))
