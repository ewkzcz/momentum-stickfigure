...
async function fixture(t) {
  ...
  const deps = { app, BrowserWindow: Window, shell, ipcMain: { on() {}, handle: (name, fn) => handlers.set(name, fn), removeHandler: name => handlers.delete(name) }, nativeTheme: {}, globalShortcut: {}, is: { dev: false }, path, pathToFileURL, protectPrivilegedNavigation, registerTrustedWindow, isTrustedIpcSender, installPrivilegedPermissions, protectWebviewAttachment, getHotkeysConfig: () => ({}), saveHotkeysConfig() {} }
